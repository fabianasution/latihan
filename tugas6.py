...
def main(): 
    ...
    if choice == "1":     #registration
        ...
        budi = "Anda berhasil log in"
        if budi == "Anda berhasil log in":
                ...
                if choice2 == "1":
                    ...
                    def transaksi():
                        ...
                        if choice4 == "1":
                            ...
                            try:
                                if inputbrang[0].isalpha() and inputjumbar.isnumeric() and (any((c in inputbrang) for c in stokbarang) == False):
                                    inputjumbar = int(inputjumbar)
                                    stokbarang.update({inputbrang: inputjumbar})
                                    transaksi()

                                elif inputjumbar.isnumeric() and (any((c in inputbrang) for c in stokbarang)):
                                    inputjumbar = int(inputjumbar)
